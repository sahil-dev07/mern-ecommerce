...
import { selectAllProducts, fetchProductsByFilterAsync, selectTotalItems, selectBrands, selectCategory, fetchCategoryAsync, fetchBrandsAsync } from '../../product/productSlice'
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                <div>
                  <Link to='/admin/product-form' className='rounded-md mx-10 my-5 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm'>
                    Add New Product
                  </Link >
                </div>
  ...
  return (
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
      <div className="flex flex-1 justify-between sm:hidden">
        ...
        <div
          onClick={() => { if (page + 1 <= totalPages) handlePage(page + 1) }}
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            ...
            <span className="font-medium">{page * ITEMS_PER_PAGE > totalItems ? page * totalItems : ITEMS_PER_PAGE}</span> of{' '}
        ...
        <div>
          ...
          >
            ...
            >
              <span onClick={() => { if (page + 1 <= totalPages) handlePage(page + 1) }} className="sr-only">Next</span>
            ...
            <div className='flex flex-col gap-3' key={product.id}>
              ...
              <div>
                <Link
                  ...
                  className='rounded-md my-5 bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm'>
                  Edit Product
                </Link>
              </div>
            </div>
