...
import { clearSelectedproduct, createProductAsync, fetchProductByIdAsync, selectBrands, selectCategory, selectedProductById, updateProductAsync } from '../../product/productSlice';
...
const ProductForm = () => {
    ...
    }, [selectedProduct, setValue, param.id])
            ...
            >
                    ...
                    <div className="border-b border-gray-900/10 pb-12">
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div className="sm:col-span-6">
                                ...
                                <div className="mt-2">
                                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-brand-600 ">
                                        <input
                                            type="text"
                                            {...register('title', {
                ...
                <div className="mt-6 flex items-center justify-end gap-x-6">
                    ...
                    {selectedProduct && !selectedProduct.deleted && (<button
                        ...
                        className="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600"
                    >
                        Delete
                    </button>)}
