...
const UserOrder = () => {
    ...
    useEffect(() => {
        if (userInfo) { // Check if user exists
                    ...
                    <div key={ind}>
                        <div className='mx-auto mt-12 max-w-7xl bg-white px-4 sm:px-6 lg:px-8'>
                            ...
                            <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                <h1 className="text-4xl my-10 font-bold tracking-tight text-gray-900">Order # {order.id}</h1>
                                <h3 className="text-2xl my-10 font-bold tracking-tight text-red-900">Status : {order.status} </h3>
